                       ...
                       this.state.items.map((item,index)=>{
                           return (
                               ...
                               <tr>
                                   ...
                                   <td>
                                       <FontAwesomeIcon className="font-awesome-icon" onClick={()=>this.handleMinus(index)} icon="minus" />
                                   </td>
                                   <td>
                                       <FontAwesomeIcon className="font-awesome-icon" onClick={()=>this.handlePlus1(index)} icon="plus" />
                                   </td>
                                   <td>
                                       <FontAwesomeIcon className="font-awesome-icon" onClick={()=>this.handleTrash(index)} icon="trash" />
                                   </td>
